package busbike.base.process.result;
...
public class ResultUtil {
     ...
     * 创建成功提示结果(带用户类型的)
     */
    public static ResultInfo createSuccess(String fileName,int messageCode,Object[] objs,String empType){
    	...
    	return new ResultInfo(ResultInfo.TYPE_RESULT_SUCCESS,messageCode,message,empType);
    }
    /**
     * 创建成功提示结果
     */
