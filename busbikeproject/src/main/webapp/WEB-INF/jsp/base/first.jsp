...
<LINK rel="stylesheet" type="text/css" href="${baseurl}js/jquery-easyui-1.5.1/themes/default.css">
...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		style='background: url("images/layout-browser-hd-bg.gif") repeat-x center 50% rgb(127, 153, 190); height: 60px; color: rgb(255, 255, 255); line-height: 20px; overflow: hidden; font-family: Verdana, 微软雅黑, 黑体;'
		border="false" split="true" region="north">
		<SPAN style="padding-right: 20px; float: right;" class="head">
			欢迎当前用户：${activeEmp.empName}&nbsp;&nbsp;
		...
		</SPAN> <SPAN style="padding-left: 10px; font-size: 30px;"><IMG
			align="absmiddle" src="images/blocks.gif" width="40" height="40">
			公共自行车管理系统</SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
	...
	<DIV style="background: rgb(210, 224, 242); height: 30px;" split="false"
		...
		<DIV class="footer">
		          系统版本号： version 0.1  发布日期：2017-01-01
	...
	<DIV style="width: 180px;" id="west" title="导航菜单" split="true"
		...
		<DIV id="nav" class="easyui-accordion" border="true" fit="true">
			<!--  导航内容 -->
		</DIV>
	</DIV>
