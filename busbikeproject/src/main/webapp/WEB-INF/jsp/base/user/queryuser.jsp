...
<script type="text/javascript">
	...
	var toolbar_v = [ {//工具栏
		...
		handler : function() {
			...
			createmodalwindow("添加用户信息", 800, 250, '${baseurl}emp/adduser.action');
		}
	} ];
	...
	$(function() {
		$('#empInfoList').datagrid({
			...
			striped : true,//条纹显示效果
			url : '${baseurl}emp/queryemp_result.action?empGroupId=3202',//加载数据的连接，引连接请求过来是json数据
	...
	function editemp(empId){
		//alert(empId);
		//打开修改窗口
		createmodalwindow("修改用户信息", 800, 250, '${baseurl}emp/edituser.action?empId='+empId);
