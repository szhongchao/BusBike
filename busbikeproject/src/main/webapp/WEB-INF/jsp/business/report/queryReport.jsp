			...
			<TABLE  class="table_search">
				<TBODY>
					<TR>
						...
						<td ><INPUT type="text" name="reportInfo.rentNetId" /></td>
						<TD class="left">报修用户：</td>
						<td><INPUT type="text"  name="reportInfo.reportName" /></TD>
						<!-- 自行添加 -->
						<TD class="left">锁装编号：</TD>
						<td ><INPUT type="text" name="reportInfo.rentNum" /></td>
						<!-- 自行添加 -->
						<TD class="left">报修日期：</TD>
						<td ><INPUT type="text" name="reportInfo.reportDate" /></td>
					</TR>
					
					<tr>
					   <!-- 自行添加 -->
						<TD class="left">故障车地址：</TD>
						<td><INPUT type="text"  name="reportInfo.carAddr" /></TD>
						<TD class="left">报修来源：</TD>
						<td >
							<select id="ypxxCustom.jyzt" name="reportInfo.reportSource" style="width:150px">
						...
						<td >
							<select id="ypxxCustom_lb" name="reportInfo.state" style="width:150px">	
							    <option value="">全部</option>
								<!-- 改成从数据字典取 -->
				  		...
				  		<td>
				  		<select id="gysypmlCustom.control" name="reportInfo.faultTypeNum" style="width:80px">
								<option value="">全部</option>
								<!-- 改成从数据字典取 -->
