...
<script type="text/javascript">
	...
	var columns_v = [ [ {
		...
		field : 'userType',//对应json中的key
		title : '用户类型',
		width : 120
	}, {
		field : 'userAddress',//对应json中的key
		title : '家庭地址',
		width : 120
	}, {
		...
		field : 'userGroupName',//对应json中的key
		title : '用户分组',
		width : 120
	},{
		field : 'userClassName',//对应json中的key
		title : '用户等级',
		width : 120 
	},{
	...
	function queryuser(){
		...
		$('#userInfoList').datagrid('load',formdata);
	...
	function edituser(userId){
		//alert(userId);
		//打开修改窗口
		createmodalwindow("修改用户信息", 800, 250, '${baseurl}user/edituser.action?userId='+userId);
	...
	<TABLE class="table_search">
		<TBODY>
			<TR>
				...
				<td><select name="userInfoCustom.userTypeId">
				...
				<TD class="left">用户信用等级：</TD>
				<td><select name="userInfoCustom.userClassId">
					<option value="">请选择</option>
					<!-- 改成从数据字典取 -->
				...
				<td><select name="userInfoCustom.userGroupId">
					<option value="">请选择</option>
					<!-- 改成从数据字典取 -->
...
<form id="userdeleteform" action="${baseurl}user/deleteuser.action" method="post">
  <input type="hidden" id="delete_id" name="userId" />
</form>
</body>
</html>