...
action="${baseurl}maintain/importmaintainsubmit.action" method="post"
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<br>2、点击 <a class="blue" href="${baseurl}template/maintain_template.xls"><u>药品信息模板</u></a> 下载，并按照说明录入药品信息。
							...
							<TR>
								...
								<TD class=category>
								<input type="file" name="maintainimportfile" />					
								</TD>
							</TR>
							<TR>
