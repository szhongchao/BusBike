         ...
         //出行地图调用
          function cycle(){
           ...
           function rentCar(){
            ...
            $("#scanButton").hide();
            location.href='${baseurl}phone/singleCar.action?carNum='+rentCarNum ;
           }
           //加载完页面即执行
          $(function () {
		    	cycle()
        ...
        <div class="easyui-navpanel" style="position:relative">
            ...
            <footer>
                <div class="m-buttongroup m-buttongroup-justified" style="width:100%">
                    ...
                    <a href="javascript:assignment()" class="easyui-linkbutton" data-options="iconCls:'icon-large-clipart',size:'large',iconAlign:'top',plain:true">任务</a>
